...
<%--    <style type="text/css">--%>
<%--        body{--%>
<%--            background-image: url(${ctx}/resource/images/bg.gif);--%>
...
<!--导航条-->
<div class="width100" style="height: 45px;background: #1c1a1a;margin-top: 40px;position: relative;z-index: 100;">
    <!--中间的部分-->
...
<div class="width1200 center_yh hidden_yh">
    <div class="width100" style="height: 45px;line-height: 45px;border-bottom: 2px solid #1c1a1a; margin-top: 20px;">
        <font class="left_yh font20">推荐漫画</font>
    </div>
...
<div class="width1200 center_yh hidden_yh">
    <div class="width100" style="height: 45px;line-height: 45px;border-bottom: 2px solid #1c1a1a; margin-top: 20px;">
        <font class="left_yh font20">热门漫画</font>
    </div>
    <div class="width100 hidden_yh" style="height: 480px;">
        <div class="normalPic">
